    ...
    <div>
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-5 justify-center">
                ...
                <div class="flex gap-1 items-center">
                    <span class="text-xs text-gray-400">1~25%</span>
                    <div class="w-4 h-4 rounded-sm bg-[#c6e48b]"></div>
                </div>
                <div class="flex gap-1 items-center">
                    <span class="text-xs text-gray-400">26~50%</span>
                    <div class="w-4 h-4 rounded-sm bg-[#7bc96f]"></div>
                </div>
                <div class="flex gap-1 items-center">
                    <span class="text-xs text-gray-400">51~75%</span>
                    <div class="w-4 h-4 rounded-sm bg-[#239a3b]"></div>
                </div>
                <div class="flex gap-1 items-center">
                    <span class="text-xs text-gray-400">76~100%</span>
                    <div class="w-4 h-4 rounded-sm bg-[#196127]"></div>
                </div>
            </div>
        </div>
        <div class="grass-graph overflow-x-auto">
            <div class="max-w-[1000px] px-10 pt-10">
                <div class="flex flex-col gap-1">
                    <div v-for="row in 7" :key="row" class="flex gap-1">
                        <template v-for="col in 53" :key="col">
                            <div v-if="isCurrentYear(getDate(row - 1, col - 1))"
                                ...
                                <div class="absolute bottom-full left-1/2 transform -translate-x-1/2 mb-2 
                                    px-2 py-1 text-xs text-white bg-gray-800 rounded-md whitespace-nowrap
