    ...
    <div class="bg-white rounded-lg p-6 w-[480px]" @click.stop>
      ...
      <ul class="space-y-[25px]">
        <li class="flex items-center">
          <span class="bg-blue-400 text-white w-8 h-8 rounded-full flex items-center justify-center mr-4">➡️</span>
          내일 하기
        </li>
        <li class="flex items-center">
          <span class="bg-purple-400 text-white w-8 h-8 rounded-full flex items-center justify-center mr-4">🔄</span>
          날짜 바꾸기
        </li>
      </ul>
    </div>
